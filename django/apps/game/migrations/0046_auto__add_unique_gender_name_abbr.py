...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Gender', fields ['name', 'abbr']
        db.create_unique(u'game_gender', ['name', 'abbr'])


    def backwards(self, orm):
        # Removing unique constraint on 'Gender', fields ['name', 'abbr']
        db.delete_unique(u'game_gender', ['name', 'abbr'])
