...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('game_audio', 'file', self.gf('audiofield.fields.AudioField')(ext_whitelist=['.mp3', '.wav', '.ogg'], max_length=100))

    def backwards(self, orm):

        # Changing field 'Audio.file'
        db.alter_column('game_audio', 'file', self.gf('django.db.models.fields.files.FileField')(max_length=100))
