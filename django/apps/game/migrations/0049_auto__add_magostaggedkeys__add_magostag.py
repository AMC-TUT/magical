...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MagosTaggedKeys'
        db.create_table(u'game_magostaggedkeys', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('object_id', self.gf('django.db.models.fields.IntegerField')(db_index=True)),
            ('content_type', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'game_magostaggedkeys_tagged_items', to=orm['contenttypes.ContentType'])),
            ('tag', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'game_magostaggedkeys_items', to=orm['game.MagosTag'])),
        ))
        db.send_create_signal(u'game', ['MagosTaggedKeys'])

        # Adding model 'MagosTag'
        db.create_table(u'game_magostag', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=100)),
            ('slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=100)),
        ))
        db.send_create_signal(u'game', ['MagosTag'])


    def backwards(self, orm):
        # Deleting model 'MagosTaggedKeys'
        db.delete_table(u'game_magostaggedkeys')

        # Deleting model 'MagosTag'
        db.delete_table(u'game_magostag')
    ...
    models = {
        ...
        u'game.magostag': {
            'Meta': {'object_name': 'MagosTag'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '100'}),
            'slug': ('django.db.models.fields.SlugField', [], {'unique': 'True', 'max_length': '100'})
        },
        u'game.magostaggedkeys': {
            'Meta': {'object_name': 'MagosTaggedKeys'},
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'game_magostaggedkeys_tagged_items'", 'to': u"orm['contenttypes.ContentType']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'object_id': ('django.db.models.fields.IntegerField', [], {'db_index': 'True'}),
            'tag': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'game_magostaggedkeys_items'", 'to': u"orm['game.MagosTag']"})
        },
        u'game.organization': {
