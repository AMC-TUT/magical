...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('game_game', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'Game.image'
        db.alter_column('game_game', 'image', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))
