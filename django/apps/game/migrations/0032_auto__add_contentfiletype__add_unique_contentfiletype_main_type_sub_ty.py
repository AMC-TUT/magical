...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ContentFileType'
        db.create_table('game_contentfiletype', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('main_type', self.gf('django.db.models.fields.CharField')(max_length=16, db_index=True)),
            ('sub_type', self.gf('django.db.models.fields.CharField')(max_length=128, db_index=True)),
        ))
        db.send_create_signal('game', ['ContentFileType'])

        # Adding unique constraint on 'ContentFileType', fields ['main_type', 'sub_type']
        db.create_unique('game_contentfiletype', ['main_type', 'sub_type'])

        # Adding field 'Image.content_type'
        db.add_column('game_image', 'content_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['game.ContentFileType'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Removing unique constraint on 'ContentFileType', fields ['main_type', 'sub_type']
        db.delete_unique('game_contentfiletype', ['main_type', 'sub_type'])

        # Deleting model 'ContentFileType'
        db.delete_table('game_contentfiletype')

        # Deleting field 'Image.content_type'
        db.delete_column('game_image', 'content_type_id')
    ...
    models = {
        ...
        'game.image': {
            ...
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['game.ContentFileType']", 'null': 'True', 'blank': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.date.today', 'auto_now_add': 'True', 'blank': 'True'}),
        ...
        'game.thumbnail': {
            ...
            'height': ('django.db.models.fields.IntegerField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'original': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['game.Image']"}),
