...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Organization.org_uuid'
        db.add_column(u'game_organization', 'org_uuid',
                      self.gf('django.db.models.fields.CharField')(max_length=36, unique=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Organization.org_uuid'
        db.delete_column(u'game_organization', 'org_uuid')
