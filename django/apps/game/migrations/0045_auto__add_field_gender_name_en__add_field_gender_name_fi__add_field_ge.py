...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Gender.name_en'
        db.add_column(u'game_gender', 'name_en',
                      self.gf('django.db.models.fields.CharField')(max_length=45, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Gender.name_fi'
        db.add_column(u'game_gender', 'name_fi',
                      self.gf('django.db.models.fields.CharField')(max_length=45, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Gender.name_it'
        db.add_column(u'game_gender', 'name_it',
                      self.gf('django.db.models.fields.CharField')(max_length=45, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Gender.name_en'
        db.delete_column(u'game_gender', 'name_en')

        # Deleting field 'Gender.name_fi'
        db.delete_column(u'game_gender', 'name_fi')

        # Deleting field 'Gender.name_it'
        db.delete_column(u'game_gender', 'name_it')
