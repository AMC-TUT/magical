...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'game_country', 'slug', self.gf('autoslug.fields.AutoSlugField')(unique_with=['name'], max_length=50, populate_from=None))

    def backwards(self, orm):

        # Changing field 'Country.slug'
        db.alter_column(u'game_country', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=45))
