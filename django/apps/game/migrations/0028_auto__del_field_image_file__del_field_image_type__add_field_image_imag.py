...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('game_image', 'file')

        # Deleting field 'Image.type'
        db.delete_column('game_image', 'type')

        # Adding field 'Image.image_file'
        db.add_column('game_image', 'image_file',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Image.image_type'
        db.add_column('game_image', 'image_type',
    ...
    def backwards(self, orm):
        ...
        db.add_column('game_image', 'file',
                      self.gf('django.db.models.fields.files.ImageField')(default='sd', max_length=100),
                      keep_default=False)

        # Adding field 'Image.type'
        db.add_column('game_image', 'type',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'Image.image_file'
        db.delete_column('game_image', 'image_file')

        # Deleting field 'Image.image_type'
        db.delete_column('game_image', 'image_type')
    ...
    models = {
        ...
        'game.image': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '45'}),
            'sha1': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '40', 'null': 'True', 'blank': 'True'}),
            'slug': ('django.db.models.fields.SlugField', [], {'unique': 'True', 'max_length': '45'}),
