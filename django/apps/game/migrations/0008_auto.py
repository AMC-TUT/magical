...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table('game_organization_users')


    def backwards(self, orm):
        # Adding M2M table for field users on 'Organization'
        db.create_table('game_organization_users', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('organization', models.ForeignKey(orm['game.organization'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('game_organization_users', ['organization_id', 'user_id'])
    ...
    models = {
        ...
        'game.userprofile': {
            ...
            'language': ('django.db.models.fields.related.ForeignKey', [], {'default': '1L', 'to': "orm['game.Language']"}),
