...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Language', fields ['code', 'slug', 'title']
        db.create_unique(u'game_language', ['code', 'slug', 'title'])

        # Adding unique constraint on 'Country', fields ['name', 'slug']
        db.create_unique(u'game_country', ['name', 'slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'Country', fields ['name', 'slug']
        db.delete_unique(u'game_country', ['name', 'slug'])

        # Removing unique constraint on 'Language', fields ['code', 'slug', 'title']
        db.delete_unique(u'game_language', ['code', 'slug', 'title'])
    ...
    models = {
        ...
        u'game.country': {
            'Meta': {'unique_together': "(('name', 'slug'),)", 'object_name': 'Country'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '45'}),
        ...
        u'game.language': {
            'Meta': {'unique_together': "(('title', 'slug', 'code'),)", 'object_name': 'Language'},
