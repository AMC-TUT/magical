...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('game_game', 'rows',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Game.cols'
        db.add_column('game_game', 'cols',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Game.block_size'
        db.add_column('game_game', 'block_size',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('game_game', 'rows')

        # Deleting field 'Game.cols'
        db.delete_column('game_game', 'cols')

        # Deleting field 'Game.block_size'
        db.delete_column('game_game', 'block_size')
