...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('game_image', (
            ...
            ('cloned', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='cloned_image_set', null=True, to=orm['game.Image'])),
        ...
        db.send_create_signal('game', ['Image'])


    def backwards(self, orm):
        # Deleting model 'Image'
        db.delete_table('game_image')
