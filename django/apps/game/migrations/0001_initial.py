...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('game_country', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=45)),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=45)),
        ))
        db.send_create_signal('game', ['Country'])

        # Adding model 'GameType'
        db.create_table('game_gametype', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=45)),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=45)),
        ))
        db.send_create_signal('game', ['GameType'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('game_country')

        # Deleting model 'GameType'
        db.delete_table('game_gametype')
