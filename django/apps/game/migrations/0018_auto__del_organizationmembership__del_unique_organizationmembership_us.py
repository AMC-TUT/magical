...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'OrganizationMembership', fields ['user', 'organization']
        db.delete_unique('game_organizationmembership', ['user_id', 'organization_id'])

        # Deleting model 'OrganizationMembership'
        db.delete_table('game_organizationmembership')

        # Adding field 'UserProfile.organization'
        db.add_column('game_userprofile', 'organization',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['game.Organization']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding model 'OrganizationMembership'
        db.create_table('game_organizationmembership', (
            ('organization', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['game.Organization'])),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal('game', ['OrganizationMembership'])

        # Adding unique constraint on 'OrganizationMembership', fields ['user', 'organization']
        db.create_unique('game_organizationmembership', ['user_id', 'organization_id'])

        # Deleting field 'UserProfile.organization'
        db.delete_column('game_userprofile', 'organization_id')
