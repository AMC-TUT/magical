...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MagosBGame'
        db.create_table(u'game_magosbgame', (
            (u'game_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['game.Game'], unique=True, primary_key=True)),
        ))
        db.send_create_signal(u'game', ['MagosBGame'])

        # Adding model 'MagosAGame'
        db.create_table(u'game_magosagame', (
            (u'game_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['game.Game'], unique=True, primary_key=True)),
            ...
            ('block_size', self.gf('django.db.models.fields.IntegerField')(default=32)),
        ))
        db.send_create_signal(u'game', ['MagosAGame'])

        # Deleting field 'Game.cols'
        db.delete_column(u'game_game', 'cols')

        # Deleting field 'Game.block_size'
        db.delete_column(u'game_game', 'block_size')

        # Deleting field 'Game.rows'
        db.delete_column(u'game_game', 'rows')

        # Deleting field 'Game.type'
        db.delete_column(u'game_game', 'type_id')


    def backwards(self, orm):
        # Deleting model 'MagosBGame'
        db.delete_table(u'game_magosbgame')

        # Deleting model 'MagosAGame'
        db.delete_table(u'game_magosagame')

        # Adding field 'Game.cols'
        db.add_column(u'game_game', 'cols',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Game.block_size'
        db.add_column(u'game_game', 'block_size',
                      self.gf('django.db.models.fields.IntegerField')(default=32),
                      keep_default=False)

        # Adding field 'Game.rows'
        db.add_column(u'game_game', 'rows',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Game.type'
        db.add_column(u'game_game', 'type',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['game.GameType']),
                      keep_default=False)
    ...
    models = {
        ...
        u'game.userprofile': {
            ...
            'gender': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['game.Gender']"}),
