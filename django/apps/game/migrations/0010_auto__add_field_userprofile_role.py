...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('game_userprofile', 'role',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1L, to=orm['game.Role']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.role'
        db.delete_column('game_userprofile', 'role_id')
    ...
    models = {
        ...
        'game.userprofile': {
            ...
            'role': ('django.db.models.fields.related.ForeignKey', [], {'default': '1L', 'to': "orm['game.Role']"}),
