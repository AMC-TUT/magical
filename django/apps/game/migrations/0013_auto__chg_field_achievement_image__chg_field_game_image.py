...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Achievement.image'
        db.alter_column('game_achievement', 'image', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Achievement.image'
        db.alter_column('game_achievement', 'image', self.gf('django.db.models.fields.CharField')(default='foo', max_length=100))

        # Changing field 'Game.image'
        db.alter_column('game_game', 'image', self.gf('django.db.models.fields.CharField')(default='foo', max_length=100))
