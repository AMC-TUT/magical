...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Image.sha1'
        db.alter_column('game_image', 'sha1', self.gf('django.db.models.fields.CharField')(unique=True, max_length=40))
        # Adding unique constraint on 'Image', fields ['sha1']
        db.create_unique('game_image', ['sha1'])


        # Changing field 'Image.image_file'
        db.alter_column('game_image', 'image_file', self.gf('django.db.models.fields.files.ImageField')(max_length=100))

    def backwards(self, orm):
        # Removing unique constraint on 'Image', fields ['sha1']
        db.delete_unique('game_image', ['sha1'])


        # Changing field 'Image.sha1'
        db.alter_column('game_image', 'sha1', self.gf('django.db.models.fields.CharField')(max_length=40, null=True))

        # Changing field 'Image.image_file'
        db.alter_column('game_image', 'image_file', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))
    ...
    models = {
        ...
        'game.image': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image_file': ('django.db.models.fields.files.ImageField', [], {'default': "'20121205121424377'", 'max_length': '100'}),
            'image_type': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '45'}),
            'sha1': ('django.db.models.fields.CharField', [], {'default': "'20121205121424377'", 'unique': 'True', 'max_length': '40', 'db_index': 'True'}),
            'slug': ('django.db.models.fields.SlugField', [], {'unique': 'True', 'max_length': '45'}),
