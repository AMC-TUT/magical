...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'game_game', 'polymorphic_ctype',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'polymorphic_game.game_set', null=True, to=orm['contenttypes.ContentType']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Game.polymorphic_ctype'
        db.delete_column(u'game_game', 'polymorphic_ctype_id')
