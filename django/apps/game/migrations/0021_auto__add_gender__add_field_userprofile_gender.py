...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Gender'
        db.create_table('game_gender', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=45)),
        ))
        db.send_create_signal('game', ['Gender'])

        # Adding field 'UserProfile.gender'
        db.add_column('game_userprofile', 'gender',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['game.Gender'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Gender'
        db.delete_table('game_gender')

        # Deleting field 'UserProfile.gender'
        db.delete_column('game_userprofile', 'gender_id')
