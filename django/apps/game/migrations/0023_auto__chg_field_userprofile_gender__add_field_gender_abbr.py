...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('game_userprofile', 'gender_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['game.Gender'], null=True))
        # Adding field 'Gender.abbr'
        db.add_column('game_gender', 'abbr',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'UserProfile.gender'
        db.alter_column('game_userprofile', 'gender_id', self.gf('django.db.models.fields.related.ForeignKey')(default='M', to=orm['game.Gender']))
        # Deleting field 'Gender.abbr'
        db.delete_column('game_gender', 'abbr')
    ...
    models = {
        ...
        'game.userprofile': {
            ...
            'gender': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['game.Gender']", 'null': 'True', 'blank': 'True'}),
