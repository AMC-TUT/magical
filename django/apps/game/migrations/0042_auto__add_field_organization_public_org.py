...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Organization.public_org'
        db.add_column(u'game_organization', 'public_org',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Organization.public_org'
        db.delete_column(u'game_organization', 'public_org')
