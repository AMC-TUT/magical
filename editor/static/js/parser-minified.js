...
*/Crafty.c("Controls",{init:function(){this.requires("Twoway"),this.enableControl()},Controls:function(e,t){return this.twoway(e,t),this}});var Parser={game:null,socket:null,blockSize:null,parseGame:function(e){Parser.game=e;var t=Parser.initGame(e.canvas);console.log("init: "+t);var n=Parser.loadSprites(e.revision.gameComponents);console.log("sprites:"+n);var r=Parser.loadAudios(e.revision.audios);console.log("audios:"+r);var i=Parser.createGameComponents(e.revision.gameComponents);console.log("gameComps:"+i);var s=Parser.createSceneComponents(e.revision.sceneComponents);console.log("gameComps:"+s);var o=Parser.createScenes(e.revision.scenes);console.log("scenes:"+o),Crafty.scene("intro")},initGame:function(e){var t=e.blockSize*e.rows,n=e.blockSize*e.columns;return Parser.blockSize=e.blockSize,Crafty.init(n,t),!0},loadAudios:function(e){var t="/static/game/audios";return _.each(e,function(e){console.log("audio"),console.log(e);var n={},r=[t+"/mp3/"+slug+".mp3",t+"/ogg/"+slug+".ogg",t+"/wav/"+slug+".wav"];n[slug]=r,Crafty.audio.add(n)}),!0},loadSprites:function(e){var t="/static/game/sprites/",n=".png";return _.each(e,function(e){var r=e.properties.sprite;if(_.isString(r)){var i={};i[r+"-sprite"]=[0,0],Crafty.sprite(Parser.blockSize,t+r+n,i)}}),!0},createScenes:function(e){_.each(e,function(e){console.log(e.name);var t=_.find(e.sceneComponents,function(e){return e.slug==="background-image"});console.log(t);var n=null,r="/static/game/sprites/",i=".png";_.isObject(t)&&_.isString(t.sprite)&&(n=r+t.sprite+i),Crafty.scene(e.name,function(){_.isNull(n)||Crafty.background("url("+n+")"),console.log(e),_.each(e.gameComponents,function(e){var t=e.position.column*Parser.blockSize,n=e.position.row*Parser.blockSize;Crafty.e(e.slug).attr({x:t,y:n,w:48,h:48})})})})},createGameComponents:function(e){return _.each(e,function(e){var t=e.properties;console.log(e);var n=_.isString(t.sprite)?t.sprite:!1,r=Crafty.c(e.slug,{init:function(){var e=this;e.addComponent("2D","Canvas"),n&&e.addComponent(n+"-sprite");if(_.isObject(t.gravity)){var r=t.gravity.direction?1:-1;e.gravity("platform"),e.gravityConst(r*t.gravity.strength)}if(_.isObject(t.controls)){var i=_.isNumber(t.controls.speed)?t.controls.speed:4;if(t.controls.method==="Fourway"){var s=_.isNumber(t.controls.jumpHeight)?t.controls.jumpHeight:12;e.addComponent("Controls","Keyboard","Gravity"),e.Controls(i,s),e.gravity("platform")}}else e.addComponent("platform")}})}),!0},createSceneComponents:function(e){return _.each(e,function(e){var t=e.properties;console.log(e);var n=_.isString(t.sprite)?t.sprite:!1,r=Crafty.c(e.slug,{init:function(){var e=this;e.addComponent("2D","Canvas"),n&&e.addComponent(n+"-sprite");if(_.isObject(t.gravity)){var r=t.gravity.direction?1:-1;e.gravity("platform"),e.gravityConst(r*t.gravity.strength)}if(_.isObject(t.controls)){var i=_.isNumber(t.controls.speed)?t.controls.speed:4;if(t.controls.method==="Twoway"){var s=_.isNumber(t.controls.jumpHeight)?t.controls.jumpHeight:12;e.addComponent("Controls","Keyboard"),e.Controls(i,s),e.gravity("platform")}t.controls.method==="Fourway"&&(e.addComponent("Fourway","Keyboard"),e.speed(i))}}})}),!0},getGame:function(e,t){socket=t,socket.emit("joinGame",e,function(e){console.log("websocket getGame (game)"),console.log(e),Parser.parseGame(e)})},getAnimation:function(e,t){var n=_.find(e,function(e){return e.key===t});return n.animation},setAnimation:function(e,t){return e.addComponent(t.id),e.animate(id,0,0,0),e.animate(id,15,1),e}};