...
$(function() {
    ...
    (function(App, $, Em, undefined) {
        ...
        App.GameComponentsView = Em.View.extend({
          ...
          }); App.InfoBoxScoreView = Em.View.extend(); App.InfoBoxSpriteView = Em.View.extend(); App.InfoBoxAnimationView = Em.View.extend(); App.InfoBoxTypeView = Em.View.extend();
          ...
          infobox.appendTo('.sortable-mainarea'); shoutbox.appendTo('.sortable-mainarea');
