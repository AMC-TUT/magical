		...
		Crafty.scene('game', function() {
			...
			if(gameinfo["level1"].platformType == "air"){
				...
				Crafty.addEvent(Crafty.stage.elem, Crafty.stage.elem, "mousedown", Crafty.stage.elem.onMouseDown);
		       	...
		       	player = Crafty.e("2D, Canvas, Physics, Player, Gravity, Keyboard, Collision, Multiway,"+playerImg).attr({x:110, y:100, z: 1001}).multiway({x:3,y:8}, {SPACE: -90, RIGHT_ARROW: 0, LEFT_ARROW: 180});
