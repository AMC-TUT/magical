        ...
        if (_.isArray(element.attr.events)) {
          ...
          self.bind('EnterFrame', function(frame) {
            ...
            if (this.isDown("LEFT_ARROW")) {
              // left
              anim = Magos.getAnimation(element.attr.events, "LEFT_ARROW");

              if (_.isObject(anim) && !self.isPlaying(anim.id)) {
                self = Magos.setAnimation(self, anim);
              }
            } else if (this.isDown("RIGHT_ARROW")) {
              // right
              anim = Magos.getAnimation(element.attr.events, "RIGHT_ARROW");
              ...
              // right
              anim = Magos.getAnimation(element.attr.events, "DOWN_ARROW");
              ...
              // right
              anim = Magos.getAnimation(element.attr.events, "UP_ARROW");
              ...
              if (!self.isPlaying(element.attr.image.id)) {
                self = Magos.setAnimation(self, element.attr.image);
              }
            }
